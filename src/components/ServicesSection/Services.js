const Services = [
  ...
  {
    title: 'Professional Services for Network Transformation',
    description:
  ...
  {
    title: 'Professional Consulting and Education Services',
    description:
